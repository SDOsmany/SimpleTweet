...
- [x] Changed the login activity to look better and more similar to twitter
- [x] If the amount of characters exceeds the max, then the tweet button will be disabled
- [x] Changed the tweet icon to make it look better
- [x] Implemeted Dark mode   
